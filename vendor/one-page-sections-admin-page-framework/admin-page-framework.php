...
final class PC3_AdminPageFramework_Registry extends PC3_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['PC3_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['PC3_AdminPageFramework_RegisterClasses'] : '';
...
final class PC3_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        ...
        new PC3_AdminPageFramework_RegisterClasses(empty(PC3_AdminPageFramework_Registry::$aClassFiles) ? PC3_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('PC3_AdminPageFramework_MinifiedVersionHeader', 'PC3_AdminPageFramework_BeautifiedVersionHeader',),), PC3_AdminPageFramework_Registry::$aClassFiles);
        PC3_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('PC3_AdminPageFramework_InclusionClassFilesHeader');
    }
