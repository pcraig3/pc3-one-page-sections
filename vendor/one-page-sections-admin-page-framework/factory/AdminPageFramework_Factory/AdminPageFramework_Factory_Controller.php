...
abstract class PC3_AdminPageFramework_Factory_Controller extends PC3_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aPC3_AdminPageFramework']['aFieldErrors'] = $this->oUtil->getElement($GLOBALS, array('aPC3_AdminPageFramework', 'aFieldErrors'), array());
    ...
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aPC3_AdminPageFramework']['aNotices'] = $this->oUtil->getElement($GLOBALS, array('aPC3_AdminPageFramework', 'aNotices'), array());
    ...
    public function hasSettingNotice($sType = '') {
        $_aNotices = $this->oUtil->getElementAsArray($GLOBALS, array('aPC3_AdminPageFramework', 'aNotices'), array());
        if (!$sType) {
