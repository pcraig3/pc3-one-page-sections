 ...
 */
abstract class PC3_AdminPageFramework_Form_Model_Export extends PC3_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new PC3_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
