 ...
 */
abstract class PC3_AdminPageFramework_Form_Model_Import extends PC3_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new PC3_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
